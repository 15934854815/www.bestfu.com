...
function highlight_subnav(url){
	$subnav = $("#accordion");
	$subnav.find("a[href='" + url + "']").parents('li.panel').addClass('active');
	$subnav.find("a[href='" + url + "']").parents('li.panel').find('ul.collapse').addClass('in');
	$subnav.find("a[href='" + url + "']").parent().addClass('active');
	$subnav.find("a[href='" + url + "']").parents('li.panel').find('a[data-toggle="collapse"]').removeClass("collapsed");

   // old  $('.side-sub-menu').find('a[href="'+url+'"]').closest('li').addClass('current');
}

//设置表单的值
function tp5_setvalue(name, value){
